/*!
 * Source: https://github.com/notwaldorf/emoji-translate
 * Copyright (c) Monica Dinculescu under the MIT License.
 *
 * Modified in the following ways (marked with "START|END MODIFICATION"):
 * - Wrapped in an IIFE to avoid global conflicts
 * - Changed path to `emojis.json`
 * - Don't return lowercased word in `getMeAnEmoji()`
 */

// START MODIFICATION
var emojiTranslate = (function () {
// END MODIFICATION
...
(function() {
  ...
  // START MODIFICATION
  request.open('GET', 'demo/emoji-translate-list.json', true);
  // END MODIFICATION
